// -----------------------------------------------------------------------
// <copyright file="DotnetPublishModule.cs" company="TedToolkit">
...
/// <summary>
/// Produces deterministic local publish archives without remote publication.
/// </summary>
/// <param name="services">The pipeline service provider.</param>
[DependsOn<DotnetPackModule>]
public sealed class DotnetPublishModule(IServiceProvider services)
